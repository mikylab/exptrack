...
| `tensorboard_example.py` | `exptrack run tensorboard_example.py --lr 0.01 --epochs 15` | Auto-capture of TensorBoard scalars — no `log_metric`, no exptrack imports (needs `pip install tensorboardX`) |
